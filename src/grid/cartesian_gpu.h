...
#define tex_texture(tex)				\
  (((Texture *)cartesian_gpu->texture->p) + tex - 1)
#define scalar_texture(s) tex_texture (_attribute[s.i].gpu.texture)
...
void gpu_reset (scalar s, double value)
{
  ...
  GL_C (glClearColor (value, 0.0f, 0.0f, 0.0f));
