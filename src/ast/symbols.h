...
enum yysymbol_kind_t
{
  ...
  sym_MACRO = 83,                     /* MACRO  */
  sym_ELLIPSIS_MACRO = 84,            /* ELLIPSIS_MACRO  */
  sym_85_ = 85,                       /* ';'  */
  sym_86_ = 86,                       /* '}'  */
  sym_87_ = 87,                       /* ')'  */
  sym_88_ = 88,                       /* '('  */
  ...
  sym_macro_call = 201,               /* macro_call  */
  sym_macro_statement = 202,          /* macro_statement  */
  sym_foreach_statement = 203,        /* foreach_statement  */
  sym_foreach_parameters = 204,       /* foreach_parameters  */
  sym_foreach_parameter = 205,        /* foreach_parameter  */
  sym_reduction_list = 206,           /* reduction_list  */
  sym_reduction = 207,                /* reduction  */
  sym_reduction_operator = 208,       /* reduction_operator  */
  sym_reduction_array = 209,          /* reduction_array  */
  sym_foreach_inner_statement = 210,  /* foreach_inner_statement  */
  sym_foreach_dimension_statement = 211, /* foreach_dimension_statement  */
  sym_forin_declaration_statement = 212, /* forin_declaration_statement  */
  sym_forin_statement = 213,          /* forin_statement  */
  sym_forin_arguments = 214,          /* forin_arguments  */
  sym_event_definition = 215,         /* event_definition  */
  sym_event_parameters = 216,         /* event_parameters  */
  sym_event_parameter = 217,          /* event_parameter  */
  sym_boundary_definition = 218,      /* boundary_definition  */
  sym_external_foreach_dimension = 219, /* external_foreach_dimension  */
  sym_attribute = 220,                /* attribute  */
  sym_new_field = 221,                /* new_field  */
  sym_root = 222                      /* root  */
};
